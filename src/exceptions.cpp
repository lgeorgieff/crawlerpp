...
// Modification 08/15/2014: Implementation of the classes exception and uri_exception.
// ====================================================================================================================
...
std::ostream& crawler_cpp::exceptions::operator<<(std::ostream &os, const crawler_cpp::exceptions::exception &err){
  os << err.get_message();
  return os;
}
...
// === class uri_exception ============================================================================================
crawler_cpp::exceptions::uri_exception::uri_exception(const std::string &message, const std::string &uri)
...
std::ostream& crawler_cpp::exceptions::operator<<(std::ostream &os, const crawler_cpp::exceptions::uri_exception &err){
